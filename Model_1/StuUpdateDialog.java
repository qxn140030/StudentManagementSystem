...
public class StuUpdateDialog extends JDialog implements ActionListener {	
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == jb1) {
			...
			try {
				// Load JDBC Driver
				Class.forName("com.microdoft.jdbc.sqlserver.SQLServerDriver");
				// create the connection object
				String url = "jdbc:microsoft:sqlserver://127.0.0.1:1443;databaseName=spdb1";
				// register driver program, open connection object
				conn = DriverManager.getConnection(url, "", "");
				String strsql = "update stu set stuName=?, stuGender=?, stuAge=?, "
